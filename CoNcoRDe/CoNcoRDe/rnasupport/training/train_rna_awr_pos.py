...
from rnasupport.environments.block_rna import SeqRNA, PosRNA
from rnasupport.modules.policy import PositionPolicy

if __name__ == "__main__":
  policy = PositionPolicy(64, depth=2)
  value = PositionPolicy(64, depth=2)
  agent = CategoricalPolicy(SharedModule(policy))
  env = PosRNA(min_size=32, max_size=33, close=True)
  training = CRRTraining(
    policy, value, agent, env,
    network_name=f"awrna/test-pos-4",
